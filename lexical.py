...
def main():
    ...
    with con:
        ...
        for row in rows:
            print(row)
        print("Number of malicious urls analyzed:")
        print(no_urls)
        print("Number of malicious tiny urls:")
        print(no_tiny_urls)
        print("Number of benign urls analyzed:")
        print(no_urls_benign)
        print("Number of benign tiny urls:")
        print(no_tiny_urls_benign)
